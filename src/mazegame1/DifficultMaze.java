 ...
 */
public class DifficultMaze extends javax.swing.JFrame implements KeyListener {

    /**
     * Creates new form DifficultMaze
     */
...
//        });
        ...
        DifficultMaze maze = new DifficultMaze();
//        mazeScreen.setVisible(true);
        Container container = maze.getContentPane(); 
            ...
            public void keyReleased(KeyEvent e) {
                try {
                    ...
                    if (e.getKeyCode() == KeyEvent.VK_UP) {
                        ...
                        int nextX = currentX;
                        int nextY = currentY - maze.heightAndWidth;
                        ...
                        int nextX = currentX + maze.heightAndWidth;
                        int nextY = currentY;
        ...
        //            t2.setSize(new Dimension(500,500));
                ...
                maze.setMoveCount(maze.getMoveCount() +1);     
                maze.winLabel.setText(Integer.toString(maze.moveCount));
                maze.winLabel.setVisible(true);
                maze.winLabel.setPreferredSize(new Dimension(150, 150));
                maze.winLabel.setFont(new Font("Serif", Font.PLAIN, 45));
                checkIfWon(nextX, nextY);
            }
            
            public boolean checkIfGreen(int nextX, int nextY, int currentX, int currentY) {
                LinkedHashMap<Character, LinkedHashMap<Integer, Integer>> startAndEndCoordinates = maze.getOtherCoordinates();
                    ...
                    for (Integer tempCoordinates : tempXandYCoordinates.keySet()) {
                        if (sORe == 'C') {
                            if (nextX == tempCoordinates && nextY == tempXandYCoordinates.get(tempCoordinates)) {
                                maze.setIgnoreWall(true);
                                maze.setGreenCollected(true);
                                maze.setGreenChecked(true);
                                return true;
                            }
                        }
                    }
            ...
            public void checkIfWallPieceWillBeRemoved(int nextX, int nextY) {
                LinkedHashMap<Integer, LinkedHashMap<Integer, Integer>> usedCoordinates = maze.getCoordinatesToFill();
                for (Integer coordinate : usedCoordinates.keySet()) {
                    ...
                    for (Integer tempCoordinates : tempXandYCoordinates.keySet()) {
                        if (tempCoordinates == nextX && tempXandYCoordinates.get(tempCoordinates) == nextY) {
                            maze.setWallRemoved(true);
                            maze.setGreenCollected(false);
                        }                                 
                    }
                }
            }
                    ...
                    for (Integer tempCoordinates : tempXandYCoordinates.keySet()) {
                        if (sORe == 'E') {
                            if (nextX == tempCoordinates && nextY == tempXandYCoordinates.get(tempCoordinates)) {
                                ...
                                maze.winLabel.setText("YOU WIN!");
                                maze.winLabel.setVisible(true);
                                maze.winLabel.setPreferredSize(new Dimension(150, 150));
                                maze.winLabel.setFont(new Font("Serif", Font.PLAIN, 45));
                                maze.homeScreen.setVisible(true);
                            }
                        }
                    }
                }
            ...
            public boolean checkMoveIsLegal(int nextX, int nextY, int currentX, int currentY, boolean skipWalls) {
                ...
                LinkedHashMap<String,Integer> boundaries = maze.getBoundaries();
            ...
            public void paint(Graphics g, int nextX, int nextY, int currentX, int currentY) {
                ...
                maze.setCurrentPosition(currentPos);
                
                
                g.setColor(Color.WHITE);
                
                g.fillRect(currentX, currentY, maze.heightAndWidth, maze.heightAndWidth);
                g.setColor(Color.BLACK);
                g.drawRect(currentX, currentY, maze.heightAndWidth, maze.heightAndWidth);
//                g.fillRect(currentX, currentY, 50, 50);
                
                g.setColor(Color.RED);
                g.drawRect(nextX, nextY, maze.heightAndWidth, maze.heightAndWidth);
                g.fillRect(nextX, nextY, maze.heightAndWidth, maze.heightAndWidth);
            }
